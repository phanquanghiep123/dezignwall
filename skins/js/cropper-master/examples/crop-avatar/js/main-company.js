(function (factory) {
  ...
  function CropAvatar($element) {
    ...
    this.$avatarModal = this.$container.find('#avatar-modal-company');
  ...
  CropAvatar.prototype = {
    ...
    addListener: function () {
      ...
      this.$avatarView.on('click',function(){
        _this.$avatar = $(this);
        if(_this.$avatar.attr("data-type") == "logo"){
          _this.$avatarModal.find(".modal-title").html("Change your company logo");
        }else{
          _this.$avatarModal.find(".modal-title").html("Change your company banner");
        }
    ...
    cropDone: function () {
      ...
      this.stopCropper();
      if(this.$avatar.attr("data-type") == "logo"){
        this.$container.find("img#avatarshow").attr("src",this.url);
      }else{
        this.$container.find(".show-banner").css("background-image","url('"+this.url+"')");
