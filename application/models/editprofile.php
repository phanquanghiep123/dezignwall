	...
	<div id="crop-avatar">
		...
		<div class="container">
			<div class="panel panel-default relative top-profile">
				...
				<h2 class="text-center"><a href="#" id="Personal_Message_Popup_show"><i class="upgrade-account-link"><?php echo $member['post_messeger'] != null ? '"'.$member['post_messeger'].'"' : '"Post all message"'?></i></a></h2>
				...
				<div class="col-md-6">
					<div class="panel panel-default relative" id="box-wall-working">
			            ...
			            <?php if(isset($list_project)):?>
										            		...
										            		<?php if(($value["countfolder"] - 5) > 0) :?>
											            		<li>
							                                        <div class="more-list-item">
							                                           <a href="<?php echo base_url("designwalls/view_photos/".$value["photo_id"])?>"> <img width="82px" height="82px" class="media-object" src="<?php echo $avatar;?>">
			            	...
			            	<?php endforeach;?>
			        	<?php endif;?>
			        	<?php if ($show_more_walls ==true && isset($list_project)) : ?>
			            	<p class="text-center" id="box-bottom-more"><a href="">MORE PROJECTS </a></p>
						<?php endif;?>
					</div>
				</div>
				<div class="col-md-6">
				                		...
				                		<div class="col-sm-12 item-experience">
					                		<div class="row">
							            		...
							            		<div class="col-sm-10">
							            			...
							            			<?php endif;?>
							            			<p>by Company <a href="<?php echo base_url("company/view/".$value["member_id"]);?>"><b><?php echo $value["company_name"]?></b></a> on <?php echo date('Y F d', strtotime($created_at_object)) ?></p>
							            			<p class="upgrade-account-link"><?php echo $type_object;?> <?php echo $value["type"] ;?> on date - <?php echo date('Y F d h:i a', strtotime($value["enter_active"])) ?></p>
							            		</div>
							            	</div>	
						            	</div>	 
				                		<?php }
			                	...
			                	foreach ($list_experience as $key => $value) {
			                		...
			                		<div class="col-sm-12 item-experience">
					            		...
					            		<div class="col-sm-10">
					            			...
					            			<p>'.date('Y F d', strtotime($value["start_day"])). get_diff_year($value["start_day"],$value["end_day"]).'</p>
			            ...
			            <div class="row">
			               <div class="col-sm-12">
			            	...
			            	<?php if(@$list_volunteer != null):?>
			                	...
			                	<p class="text-center" id="box-bottom-more"><a id="more-volunteer-now" href="">MORE Volunteen Expertion</a></p>
			                	<?php endif;?>
			                <?php endif;?>   				            
			            </div>	
					</div>
		            ...
		            <div class="media">
	                    <div class="media-body">
	                        ...
	                        <div class="form-group">
	                            ...
	                            <div class="col-sm-8 remove-padding">
	                                <input type="text" validate data-validate="phone" class="work_ph form-control format-phone" name="work_ph" value="<?php echo @$member["work_ph"]; ?>" placeholder="Your work phone...">
	                            </div>
	                        </div>
	                        ...
	                        <div class="form-group">
	                            <label for="work-company" class="col-sm-4 control-label"><small>DesignWall Handle:</small></label>
	                            <div class="col-sm-8 remove-padding">
