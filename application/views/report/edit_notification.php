    ...
    <div class="col-md-12">
      ...
      <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" name="title" id="title" value="<?php echo @str_replace('"', "&quot;", @$record["title"]); ?>" placeholder="Enter Title">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10"> 
          <textarea style="height:150px; " class="form-control" name="summary" id="summary" placeholder="Enter summary"><?php echo @$record["summary"];?></textarea>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <textarea style="height:200px; " class="form-control" name="content" id="content" placeholder="Enter content"><?php echo @$record["content"];?></textarea>
          </div>
        </div>
        <div class="form-group">
          <?php
            if($record['image'] != "" && file_exists(FCPATH . $record['image'])){
                $image = '<img style="width:100%;" src="'.base_url($record['image']).'"/>';
            }
          ?>
