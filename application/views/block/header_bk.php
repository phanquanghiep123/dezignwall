                                       ...
                                       ?>
                                        <div class="col-user-item">
                                            <ul class="menu-img">
                                                ...
                                                <?php if($h_sr != ""):?><li><?php echo $h_sr;?></li><?php endif;?>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-6 border-right column-left box-favorite">
                            <p class="remove-bottom-10">Lates updates from the companeis you follow:</p>
                                ...
                                <?php 
                                    ...
                                    <li>
                                        <a href="<?php echo base_url("company/view/".$value["member_id"])?>">
                                            <img height="50px" width="50px" class="img-circle" src="<?php echo base_url($avatar)?>">
                                        </a>
                        ...
                        <div class="col-md-6 border-left column-right box-favorite">
                            ...
                            <div class="media remove-margin">
                                ...
                                <div class="media-body">
                                    <a id="btn-add-social" class="btn-up-comment" href="#">Hi <?php echo @$user["first_name"];?>! What on your mind?</a>
                                </div>
                            </div>
                        </div>           
                    </div>
