...
<script type="text/javascript">
  dataLayer = [{
      mid :"<?php echo @$user_info["member_id"];?>",
      transactionPromo:null,
      transactionProducts:[
        {
          sku : "<?php echo @$value["id"] ?>",
          name : "plan <?php echo strip_tags(@$value["name"])?>",
          category: "Monthly",
          price:"<?php echo strip_tags(@$value["price"])?>",
          quantity: 1,
        }
      ],
...
<section class="section box-wapper-show-image">
  <div class="container">
    <?php if ($post != null) : ?>
      <div class="alert alert-danger">
        ...
        if ($this->session->flashdata('message')) : 
          ...
          echo '<strong>Payment fail</strong> sorry your payment failed. Please try again.';
        endif;
        ?>
      </div>
    <?php else : ?>
    ...
    <div class="upgrade-panel none-style">
        ...
        <div class="custom">
                    <div class="row">
                        ...
                        <div class="col-sm-6 text-right">
                            <form id="paypal-button-form" action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
      ...
      <div class="upgrade-panel remove-border-top">
        ...
        <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="text" placeholder="First Name" class="form-control" title="First Name" data-valid="true" maxlength="50" id="first_name" name="first_name">
            </div>
          </div>
          <div class="form-group">
            <label for="inputEmail3" class="col-sm-4 control-label">Last Name:</label>
            <div class="col-sm-8">
                <input type="text" placeholder="Last Name" class="form-control" title="Last Name" data-valid="true" maxlength="50" id="last_name" name="last_name">
            </div>
          </div>
          <div class="form-group">
            <label for="inputEmail3" class="col-sm-4 control-label">Address 1:</label>
            <div class="col-sm-8">
                <input type="text" placeholder="Address 1" class="form-control" title="Address 1" data-valid="true" maxlength="200" id="address1" name="address1">
            </div>
          </div>
          <div class="form-group">
            <label for="inputEmail3" class="col-sm-4 control-label">Address 2 (option):</label>
            <div class="col-sm-8">
                <input type="text" placeholder="Address 2" class="form-control" title="Address 2" maxlength="200" id="address2" name="address2">
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-sm-4">
                <input type="text" class="form-control format-number" title="Zip Code" maxlength="10" id="zipcode" name="zipcode" placeholder="Zip">
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="text" placeholder="Credit Card Number" class="form-control" title="Credit Card" maxlength="20" id="card_number" name="card_number">
            </div>
          </div>
          <div class="form-group">
            <label for="inputEmail3" class="col-sm-4 control-label">Security Code:</label>
            <div class="col-sm-4">
                <input type="text" placeholder="Security Code" class="form-control" title="Security Code" maxlength="6" data-valid="true" data-valid="true" id="security_code" name="security_code">
            </div>
            <div class="col-sm-4">
          ...
          <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" title="Month" min="1" max="12" maxlength="2" id="month" name="month" placeholder="Month">
                    </div>
                    <div class="col-sm-4">
                        <input type="text" class="form-control" title="Year" min="2016" max="3000" maxlength="4" id="year" name="year" placeholder="Year">
                        <input type="hidden" name="package_id" id="package_id" value="<?php echo $value['id']; ?>" />
                        <input type="hidden" name="card_type" id="card_type" value="" />
              			<input type="hidden" name="payment_nonce_client" value="<?php echo $clientToken; ?>" />
                    </div>
          </div>
          <div class="form-group promo-code-box">
                <label for="promo-code" class="col-sm-4 control-label">Promo Code:</label>
                <div class="col-sm-4" style="padding-top:10px;">
                    <input type="text" class="form-control" title="Promo Code" id="promo_code" name="promo_code" placeholder="Promo Code">
                </div>
                <div class="col-sm-4">
                    <button class="btn btn-lg btn-primary pull-right remove-margin submit-purchase">Complete Upgrade</button>
                </div>
          </div>
          <div class="row"></div>
      ...
      <p class="text-center">Your credit card will be charge when you click Complete Purchase. A copy of your subscription details will be sent to you via email for your records. 

At the end of your current upgrade, Dezignwall will automatically continue your subscription for the same period and amount as your current upgrade. 

Upgrade today and start promoting your brand.</p>
    </form>
  </div>
</section>
      ...
      <div class="modal-dialog">
            <div class="modal-content">
                  <div class="modal-body text-center">
                        ...
                        <div class="space-20"></div>
                        <p class="remove-margin">Note: At the end of your promotion period, you will be automatically enrolled in a recurring monthly billing plan until you upgrade or cancel your subscription.</p>
                        <div class="space-20"></div>
                        <div class="text-right">
...
<script type="text/javascript">
  ...
  $(function() {
    $("#promo_code").val('<?php echo @$_GET["promo_code"]; ?>');
    <?php 
      if ($post != null) :
        foreach ($post as $key => $val) :
          if ($key !== 'security_code' && $key !== 'card_number') :
            echo '$("#'.$key.'").val("' . $val . '");';
          endif;
        endforeach;
      endif;
    ...
    $(".submit-purchase").click(function () {
      ...
      if (valid == true) {
        if ($.trim($('#zipcode').val()) == '') {
          ...
          $(".error-client").html("Please enter required field Zip code");
          $(".error-client").show();
        ...
        if ($.trim($('#year').val()) == '') {
          ...
          $(".error-client").html("Please enter required field Year");
          $(".error-client").show();
        $(this).removeAttr('disabled');
        return false;
        }
        if (!valid_card) {
          $('#card_number').addClass('warning');
        ...
        if ($.trim($("#promo_code").val()) != '') {
          ...
          success : function(data) {
            if (data["success"] == "success") {
              ...
              //$('#promo-code-popup').html(data["offer_code"]);
