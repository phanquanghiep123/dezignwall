			...
			<div class="upgrade-panel remove-border-top">
				...
				<div class="form-group">
	  			...
	  			<div class="form-group">
		    		...
		    		<div class="col-sm-8">
		      			<input type="number" placeholder="Credit Card Number" class="form-control" title="Credit Card" maxlength="20" id="card_number" name="card_number">
		    		</div>
	  			</div>
	  			<div class="form-group">
      ...
      <div class="modal-dialog">
            <div class="modal-content">
                  <div class="modal-body text-center">
                      ...
                      <div class="space-10"></div>
                      <p><span class="color-red-dark"><strong>Savings!</strong></span> Thank you for joining Dezignwall! Here are your new
      billing terms, based on the promo code you’ve entered.</p>
                        <div class="space-20"></div>
                        <div class="row">
                              <div class="col-md-8 col-md-offset-2">
