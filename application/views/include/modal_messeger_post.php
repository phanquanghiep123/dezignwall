	    ...
	    <form method="post" id="add_post_messenger" action="<?php echo base_url("profile/add_post_messenger")?>">
		    <div class="modal-content">
		        ...
		        <div class="modal-body">
		          	<p id="set-memseger">Share with the community what's on your mind</p>
    ...
    $(document).ready(function(){
    	$("body #Personal_Message_Popup_show").click(function(){
    		...
    		if(type_data == "company"){
    			$("#Personal_Message_Popup .modal-title").html("Tell us about your company...");
    			$("#Personal_Message_Popup [name=messenger]").attr("placeholder","Have fun and show your personality...");
                $("#Personal_Message_Popup #set-memseger").html("Give the design community the scoop on your company...");
                $("#Personal_Message_Popup .note").html("In your own words, tell us what makes your company unique. The design industry is looking for the inside scoop on what comapnies they want to engage with. This is your chance to share.");
    		}else{
    			$("#Personal_Message_Popup .modal-title").html("Post a pesonal message!");
    			$("#Personal_Message_Popup [name=messenger]").attr("placeholder","Have fun and show your personality...");
                $("#Personal_Message_Popup #set-memseger").html("Share with the community what's on your mind");
                $("#Personal_Message_Popup .note").html("Maybe you’re looking for new opportunities? Maybe you just want to say something inspirational? This is your space to get creative and share!");
    		}
