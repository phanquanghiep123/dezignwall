							...
							if($key_1 < 6){
								...
								if($list_record != null){
									foreach ($list_record as $key => $value) {
										...
										if($key  == 0) {
											$created_at = date('F d\, Y \a\t g:ia', strtotime($value["created_at"]));
								...
								echo '
								<div class="media">
									<div class="media-left"> <img src="'.$avatar.'" class="img-circle notification-avatar"> </div>
			...
			<div class="body-child-main">
				...
				<?php 
					foreach ($follow_record as $key_3 => $value) {
						...
						if($key_3 < 6){ ?>
							<div class="media">
								<div class="media-left"> <img class="img-circle notification-avatar" src="<?php echo $avatar;?>"> </div>
								<div class="media-body">
									<div class="row">
										<div class="col-sm-8">
