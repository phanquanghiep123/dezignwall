...
<section class="section box-wapper-show-image">
	<div class="container">
		...
		<form class="form-horizontal form-gray" action="<?php echo base_url("/checkout/credit"); ?>" method="POST" id="form-purchase">
			...
			<div class="upgrade-panel remove-border-top">
				<div class="payment-logos text-center">
	  			...
	  			<div class="form-group">
		    		...
		    		<div class="col-sm-8">
		      			<input type="text" class="form-control" data-valid="true" maxlength="50" id="first_name" name="first_name">
		    		</div>
	  			</div>
	  			<div class="form-group">
	    			<label for="inputEmail3" class="col-sm-4 control-label">Last Name:</label>
		    		<div class="col-sm-8">
		      			<input type="text" class="form-control" data-valid="true" maxlength="50" id="last_name" name="last_name">
		    		</div>
	  			</div>
	  			<div class="form-group">
	    			<label for="inputEmail3" class="col-sm-4 control-label">Address 1:</label>
		    		<div class="col-sm-8">
		      			<input type="text" class="form-control" data-valid="true" maxlength="200" id="address1" name="address1">
		    		</div>
	  			</div>
	  			<div class="form-group">
	    			<label for="inputEmail3" class="col-sm-4 control-label">Address 2 (option):</label>
		    		<div class="col-sm-8">
		      			<input type="text" class="form-control" maxlength="200" id="address2" name="address2">
		    		</div>
	  			</div>
	  			<div class="form-group">
	    			<label for="inputEmail3" class="col-sm-4 control-label">City/Zip:</label>
		    		<div class="col-sm-4">
		      			<input type="text" class="form-control" data-valid="true" maxlength="50" id="city" name="city" placeholder="City">
		    		</div>
		    		<div class="col-sm-4">
		      			<input type="number" class="form-control format-number" maxlength="10" id="zipcode" name="zipcode" placeholder="Zip">
		    		</div>
		    	</div>
	  			<div class="form-group">
	    			<label for="inputEmail3" class="col-sm-4 control-label">State/Country:</label>
		    		<div class="col-sm-4">
		      			<input type="text" class="form-control" data-valid="true" maxlength="20" id="state" name="state" placeholder="State">
		    		</div>
		    		<div class="col-sm-4">
		      			<select name="country" class="form-control" style="width:100%;" id="country" required="required">
	  			...
	  			<div class="form-group">
		    		...
		    		<div class="col-sm-8">
		      			<input type="number" class="form-control" maxlength="20" id="card_number" name="card_number">
		    		</div>
	  			</div>
	  			<div class="form-group">
	    			<label for="inputEmail3" class="col-sm-4 control-label">Security Code:</label>
		    		<div class="col-sm-4">
		      			<input type="text" class="form-control" maxlength="6" data-valid="true" data-valid="true" id="security_code" name="security_code">
		    		</div>
		    		<div class="col-sm-4">
	  			...
	  			<div class="form-group">
        		    		...
        		    		<div class="col-sm-4">
        		      			<input type="number" class="form-control format-number-advance" min="1" max="12" maxlength="2" id="month" name="month" placeholder="Month">
        		    		</div>
        		    		<div class="col-sm-4">
        		      			<input type="number" class="form-control format-number-advance" min="2016" max="3000" maxlength="4" id="year" name="year" placeholder="Year">
		  		...
		  		<p class="text-center">I agree with the <a href="">Terms and Conditions</a> and understand that this upgrade is non-refundable</p>
		  		<div class="space-10"></div>
			</div>
...
<script type="text/javascript">
    ...
    $(".submit-purchase").click(function () {
    	...
    	if (valid == true) {
    		if (!valid_card) {
				messenger_box("Error message", "Invalid card number.");
    	...
    	messenger_box("Error message", message);
    	$(this).removeAttr('disabled');
		return false;
	});
</script>