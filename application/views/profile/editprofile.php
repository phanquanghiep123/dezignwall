				                		...
				                		<div class="col-sm-12 item-experience">
					                		<div class="row">
							            		...
							            		<div class="col-sm-10">
							            			...
							            			<?php endif;?>
							            			<p>by <a href="<?php echo base_url("company/view/".$value["member_id"]);?>"><b><?php echo $value["company_name"]?></b></a> on <?php echo date(DW_FORMAT_DATETIME, strtotime($created_at_object)); ?></p>
							            			<?php $value["type"] = str_replace("photo","image",$value["type"]) ; ?>
							            			<p class="upgrade-account-link"><?php echo $type_object;?> <?php echo $value["type"] ;?> on date - <?php echo date(DW_FORMAT_DATETIME, strtotime($value["enter_active"])) ?></p>
							            		</div>
							            	</div>	
						            	</div>	 
				                		<?php }
