    ...
    <div class="container">
        <div class="panel panel-default">
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <form action="" method="post" class="form-horizontal form-profile" autocomplete="off">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                ...
                                <p class="edit-profile" style="display:none;"><input  type="text" value="<?php echo @$member['cellphone']; ?>" id="personal_cellphone" class="form-control" placeholder="Cell Phone" name="personal[cellphone]"></p>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                ...
                                <p class="edit-profile" style="display:none;"><input type="password" class="form-control" id="password" id="personal_password" placeholder="Password" name="personal[password]"></p>
                            </div>
                        </div>
                        <div class="form-group">
...
<script type="text/javascript">
    $(document).ready(function(){
    	/*$('#input-seach').focus();
    	// Clear value textbox
    	var cellphone = "<?php echo @$member['cellphone']; ?>";
    	if ($.trim(cellphone) == '') {
    		setTimeout(function(){  
				$('#personal_cellphone').val('');
			},100);
		}
		$('#personal_password').val('');
		$('#personal_confirmpassword').val('');
		*/
