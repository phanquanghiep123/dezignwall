    ...
    <div class="container" style="position: relative;min-height:400px;">
        ...
        <div class="company_catalog">
            ...
            <div class="row">
                <div class="col-xs-8">
                    <div class="box-seach">
                        <form id="seach-home-photo" method="GET" class="relative form-color">
                            <input type="text" class="form-control" value="<?php echo @$_GET['keyword_photo']; ?>" name="keyword_photo" value="" placeholder="Search Catalog..." autocomplete="off">
