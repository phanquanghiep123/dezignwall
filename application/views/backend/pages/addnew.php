			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<div class="form-group">
						<label>Title</label>
						<?php $data = array('name' => 'page_title', 'value' => '', 'class'=>'form-control','id' => 'page_title','placeholder'=> 'Page Title');
            				echo form_input($data); ?>
					</div>
					<div class="form-group">
						<label>Content</label>
						<?php $data = array('name' => 'page_content', 'value' =>'', 'class'=>'form-control','id' => 'page_content');
				...
				<div class="panel-body">
					<div class="form-group">
						...
						<?php 	$options = array('0'=>'Select Parent');
							...
							echo form_dropdown('page_parent', $options, '', 'class="form-control" id="page_parent"');?>
					</div>
					<div class="form-group">
						...
						<?php 	$options = array(
							...
							echo form_dropdown('page_template', $options, '', 'class="form-control" id="page_template"');?>
					</div>
