                    ...
                    <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                        <div class="panel panel-default relative">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <p class="edit-profile"><input type="text" value="<?php echo @$value['web_address']; ?>" class="form-control remove required format-url" placeholder="Website" name="web_address"></p>
                                </div>
                            </div>
                            <div class="form-group">
...
.business-page .profile-image .avatar-full{
     width: 170px ;
    height: 170px;
}
.business-page .profile-edit-photo.custom-avatar {
    top: 0;
    left: 0;
    width: 170px ;
    height: 170px;
...
.business-page .profile-edit-photo .profile-action-edit {
    width: 100%;
    height: 100%;
    display: table;
    table-layout: fixed;
}
.business-page .profile-edit-photo .profile-action-edit a {
    padding: 5px 10px;
    float: none;
    font-size: 16px;
    color: #fff;
...
.business-page  .profile-edit-photo.custom-logo a, .business-page  .profile-edit-photo.custom-avatar a{
