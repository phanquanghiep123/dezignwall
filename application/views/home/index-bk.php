<?php if (!isset($is_login) || $is_login != true) : ?>
    ...
    <div class="section section-1 relative">
        ...
        <div id="slider-home-page">
            ...
            <div class="slider-home-video"><video  autoplay muted loop webkit-playsinline src="<?php echo skin_url("media/Dezignwall-Index-Page-Video-8.mp4");?>" id="video1" class="video"  poster ="<?php echo skin_url("images/bg-slider.png")?>" width="100%"></video></div>
            <div id="home-bg-slider">
                <div class="seach-in-slider">
                    ...
                    <h4>A visual way to discover and source products and design inspiration
with tools to make collaborating on the go, easy.</h4>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="box-intro">
                            ...
                            <a href="#" class="singup" id="get-started"><strong>Get started...</strong></a>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="box-intro">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-9 text-sm-center">
                            <h1>Are you design firm or product manufacturer?</h1>
                        </div>
                        <div class="col-md-3 text-left text-sm-center">
                            <a class="btn singup" id="get-started" href="#">Sign Up</a>
                        </div>
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
            ...
            $("#jquery_jplayer_1").jPlayer({
                ready: function () {
                    $(this).jPlayer("setMedia", {
                        title: "Dezignwall",
                        mp4: "<?php echo base_url("skins/media/dezignwall-the-power-to-go-digital.mp4");?>",
                        m4v: "<?php echo base_url("skins/media/dezignwall-the-power-to-go-digital.m4v");?>",
                        ogv: "<?php echo base_url("skins/media/dezignwall-the-power-to-go-digital.ogv");?>",
                        webmv: "<?php echo base_url("skins/media/dezignwall-the-power-to-go-digital.webm");?>",
                        poster: "<?php echo base_url("skins/images/poster.png");?>"
                    });
                },
    ...
    $(window).load(function(){
        $("#slider-home-page").show();
    });
   // $("#slider-home-page .jp-video-play-icon").click(function(){
      //  $("#slider-home-page #home-bg-slider").show();
    //});
</script>