                                                            ...
                                                            <div>
                                                                ...
                                                                <div class="col-sm-4">
                                                                    <ul class="list-inline action-img">
                                                                        <li><a><img src="<?php echo skin_url("icon/icon-user.png");?>"></a></li>
                                                                        <li><a id="reports-email" data-name="<?php echo $value["first_name"]. " ".$value["last_name"] ;?>" data-email ="<?php echo $value["work_email"];?>" href="javascript:;" href="javascript:;"><img src="<?php echo skin_url("/icon/icon-message.png");?>"></a></li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                        </div>
