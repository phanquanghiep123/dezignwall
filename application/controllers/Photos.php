                        ...
                        switch ($object) {
                            case 'comment':
                                ...
                                <div class="row">
                                    <div class="col-sm-9">
                                        <div class="media">
                                            <div class="media-left"> <a href="'.base_url("photos/".$value["reference_id"]."").'/'.gen_slug($value["name"]).'"><img class="'.$value["typeSuccess"].' img-circle" src="'.$avatar.'" width="40px"> </a></div>
                                            <div class="media-body">
                            ...
                            case 'like':
                                $html_data .='<div class="media">
                                    <div class="media-left"> <a href="'.base_url("photos/".$value["reference_id"]."").'/'.gen_slug($value["name"]).'"><img src="'.$avatar.'" class="'.$value["typeSuccess"].' media-object" width="50px"></a> </div>
                                    <div class="media-body">
